...
function Products(props) {
    ...
    return (
        <>
        <Search setSearch={setSearch} search={search} products={products} searchFilter={searchFilter}/>
            <section className="products">
                {products.filter(searchFilter).map(({id, images, name, description, price, currency}) => (
