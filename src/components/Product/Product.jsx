                    ...
                    <div className="product">
                        <main className="container">
                            <section className="slider">
                                <div className="slider__slides">
                                    ...
                                    <div className="slider__navigation">
                                        {product.images && product.images.map((img, idx) => (
                                            <label htmlFor={`r${idx + 1}`} className="slider__bar" key={idx}></label>
                                        ))}
                                    </div>
                                </div>
                            </section>
                            ...
                            <section>
                                <div>
                                    ...
                                    <div className="card__footer">
                                        <span className="card__price">{product.price} {product.currency}</span>
                                    </div>
                                </div>
                            ...
                            <section className="container container--opinion">
                                ...
                                {product.opinions && product.opinions.map(({id, stars, content, author}) => (
